...
public class WeaponBobbing : MonoBehaviour
{
    ...
    private PlayerMovementNew fpsController;
    ...
    void Start()
    {
        fpsController = GameObject.FindGameObjectWithTag("LocalPlayer").GetComponent<PlayerMovementNew>();
        wallRun = GameObject.FindGameObjectWithTag("LocalPlayer").GetComponent<WallRun>();
    ...
    void Update()
    {
        ...
        if (!fpsController.isGrounded && !wallRun.onWall) return;
